...
router.post('/', authorize('super_admin', 'admin', 'manager'), validate(createServiceSchema), createService);
router.put('/:id', authorize('super_admin', 'admin', 'manager'), validate(updateServiceSchema), updateService);
